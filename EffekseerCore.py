...
EffekseerCoreDeviceType_DirectX9 = _EffekseerCore.EffekseerCoreDeviceType_DirectX9
EffekseerCoreDeviceType_DirectX11 = _EffekseerCore.EffekseerCoreDeviceType_DirectX11
class EffekseerBackendCore(object):
    ...
    @staticmethod
    def InitializeWithOpenGL():
        return _EffekseerCore.EffekseerBackendCore_InitializeWithOpenGL()
...
def EffekseerBackendCore_InitializeWithOpenGL():
    return _EffekseerCore.EffekseerBackendCore_InitializeWithOpenGL()
...
class EffekseerEffectCore(object):
    ...
    def GetCurvePath(self, index):
        return _EffekseerCore.EffekseerEffectCore_GetCurvePath(self, index)
    ...
    def GetCurveCount(self):
        return _EffekseerCore.EffekseerEffectCore_GetCurveCount(self)

    def LoadCurve(self, *args):
        return _EffekseerCore.EffekseerEffectCore_LoadCurve(self, *args)

    def HasCurveLoaded(self, index):
        return _EffekseerCore.EffekseerEffectCore_HasCurveLoaded(self, index)
...
class EffekseerManagerCore(object):
    ...
    def SetEffectRotation(self, handle, x, y, z):
        return _EffekseerCore.EffekseerManagerCore_SetEffectRotation(self, handle, x, y, z)

    def SetEffectScale(self, handle, x, y, z):
        return _EffekseerCore.EffekseerManagerCore_SetEffectScale(self, handle, x, y, z)
    ...
    def DrawBack(self, layer=1):
        return _EffekseerCore.EffekseerManagerCore_DrawBack(self, layer)

    def DrawFront(self, layer=1):
        return _EffekseerCore.EffekseerManagerCore_DrawFront(self, layer)

    def SetLayer(self, handle, layer):
        return _EffekseerCore.EffekseerManagerCore_SetLayer(self, handle, layer)
    ...
    def SetBackground(self, glid, hasMipmap):
        return _EffekseerCore.EffekseerManagerCore_SetBackground(self, glid, hasMipmap)

    def UnsetBackground(self):
        return _EffekseerCore.EffekseerManagerCore_UnsetBackground(self)

    def SetDepth(self, glid, hasMipmap):
        return _EffekseerCore.EffekseerManagerCore_SetDepth(self, glid, hasMipmap)

    def UnsetDepth(self):
        return _EffekseerCore.EffekseerManagerCore_UnsetDepth(self)
